...
class Brick(pygame.sprite.Sprite):
    ...
    def collide(self, ball):
        ...
        has_collided = not ball.get_collision_state() and ((ballX + radius) >= brickX and (ballX - radius) <= (brickX + brickW)) and (
...
class BrickGroup(pygame.sprite.Group):
    ...
    def collide(self, ball):
        ...
        # todo : sort brick by distance to the ball
...
while True:
    ...
    for y in range(16):
        for x in range(24):
            pygame.draw.rect(screen, (r2, g2, b2), (-360 + x * 60 + h_scroll, -10 + y * 60 + v_scroll, 50, 50), 2)
    for y in range(16):
        for x in range(24):
            pygame.draw.rect(screen, (r1, g1, b1), (-385 + x * 60 + h_scroll, -35 + y * 60 + v_scroll, 40, 40), 0)
            pygame.draw.rect(screen, (r2, g2, b2), (-375 + x * 60 + h_scroll, -25 + y * 60 + v_scroll, 20, 20), 0)
